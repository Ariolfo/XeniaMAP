"""
Shared Copernicus Data Space Ecosystem (CDSE) client helpers.

OAuth token, credentials, catalogue/STAC URLs, and OData attribute access
used by Sentinel-1/2 download paths and Fire S2 partial download.
"""
...
def get_copernicus_credentials(settings: Any) -> tuple[str, str]:
    ...
    Mismas credenciales para descarga Sentinel-2 y Sentinel-1 (token OAuth + OData):
